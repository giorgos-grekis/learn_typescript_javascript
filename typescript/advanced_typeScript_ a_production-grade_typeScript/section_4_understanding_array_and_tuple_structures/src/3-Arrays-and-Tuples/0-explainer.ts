/**
 * Tuple types define sets of arrays with a fixed length
 * where each index can hold a value of a different type
 *
...
// This allows you to access the type of the elements inside the array.
...
type Name2 = [first: string, last: string] | [first: string, middle: string, last: string];
