...
type State = Record<"valid" | "edited" | "focused", boolean>;

type State2 = { [key in "valid" | "edited" | "focused"]: boolean };

// type StateSimple = { valid: boolean; edited: boolean; focused: boolean };
