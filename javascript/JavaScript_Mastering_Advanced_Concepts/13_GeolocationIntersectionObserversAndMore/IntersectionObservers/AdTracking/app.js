...
/**
 *  { threshold: 0.5 } => when 50% of the element is visible IntersectionObserver will be trigger
 *
 */
...
/**
 * { threshold: [0, 0.25, 0.5, 0.75, 1] } => 0% or 1px, 25%, 50%, 75%, 100%
 * Can we pass an array of values
 */
// const observer = new IntersectionObserver(
//   (entries) => {
//     entries.forEach((entry) => {
